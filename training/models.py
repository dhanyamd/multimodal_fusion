...
import torch 
from torch._inductor.utils import P
...
def compute_class_weights(dataset): 
    ...
    skipped = 0
    total = len(dataset) 
    print("\ Counting class contributions")
...
if __name__ == "__main__": 
    ...
    model.eval() 
    text_inputs = {
        'input_ids': sample['text_inputs']['input_ids'].unsqueeze(0),  # pyright: ignore[reportUndefinedVariable]
